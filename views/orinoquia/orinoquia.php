...
inner join publicaciones on image.idimage = publicaciones.id_imagen where id_region=4");
$sql->execute();
...
<head>
  ...
  <title>Ecoturismo y áreas protegidas en la Orinoquía -</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Busqueda por Regiones</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              ...
              <li><a href="./orinoquia.php">La Orinoquía</a></li>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          ...
          <p><font color="orange">Recuerda cuidar los recursos hidricos, procura llevar contigo una bolsa de basura, y al llegar al lugar de ospedaje dejarla en el lugar indicado</p>
          <?php if (!isset($_SESSION['id'])) { ?>
