...
inner join publicaciones on image.idimage = publicaciones.id_imagen where id_region=5");
$sql->execute();
...
<head>
  ...
  <title>Ecoturismo y áreas protegidas en la Amazonía -</title>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          ...
          <p><font color="orange">Antes de viajar, aprende tanto como sea posible del lugar de destino, recursos naturales, cultura y hábitos de sus lugareños.</p>
          <?php if (!isset($_SESSION['id'])) { ?>
  ...
  <div class="container">
    <footer class="py-5 footer">
      ...
      <div class="d-flex flex-column flex-sm-row justify-content-center py-4 my-4 border-top">
        <p class="copyright text-muted">&copy; 2022 CEPIS-Ecotours, Inc. Todos los derechos resvados.</p>
      </div>
    </footer>
    <!-- End Footer -->
