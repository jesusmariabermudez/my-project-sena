...
inner join publicaciones on image.idimage = publicaciones.id_imagen where id_region=2");
$sql->execute();
...
<head>
  ...
  <title>Ecoturismo y áreas protegidas en las zonas Andina e Insular -</title>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          ...
          <p><font color="orange">Regla maxima de Ecoturismo, respeto al medio Ambiente, sus señales y entorno. Qué tu fotgrafia no dañe el Ecosistema.</p>
          <?php if (!isset($_SESSION['id'])) { ?>
