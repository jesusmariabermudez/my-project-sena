...
inner join publicaciones on image.idimage = publicaciones.id_imagen where id_region=1");
$sql->execute();
...
<head>
  ...
  <title>Ecoturismo y áreas protegidas en el Caribe -</title>
...
<!-- ==== Aqui ubicamos las rutas de conección==== -->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          ...
          <p><font color="orange">Di sí a los medios de transporte sostenibles, si te gusta el Ecoturismo como la bicicleta, caballo, que tengan el menor inpacto ambiental.</p>
          <?php if (!isset($_SESSION['id'])) { ?>
