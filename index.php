        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Busqueda por Regiones</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              ...
              <li><a href="./views/andina/andina.php">Las zonas Andina e Insular</a></li>
            </ul>
          </li>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          ...
          <p><font color=/"green/">Opta por comprar productos locales que ofrecen los lugareños. Así apoyas la generación se empleo.</p>
          <?php if (!isset($_SESSION['id'])) { ?>
          ...
          <?php foreach ($resultado as $row) { ?>
            <div class="col-xl-3 col-lg-4 col-md-6">
              ...
              <div class="gallery-item h-100">
                <!--Esta imagen es de la base de datos, se codifica en base64 para poder leerla en el html -->
                <img src="data:image/png;base64,<?php echo base64_encode($row['img']) ?>" class="img-fluid" alt="">
                <div class="gallery-links d-flex align-items-center justify-content-center">
                  <!--Esta imagen esta almacena en la crpeta con la siguiente ruta: /views/dashboard/dashbo4rd/  -->
                  <a href="./views/dashboard/dashbo4rd/<?php echo $ruta; ?>" title="<?php echo $nombre; ?>" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                  <a href="./views/detalles.php?id=<?php echo $id; ?>" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div>
